...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://postimg.cc/BtFbVVgV')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'BHARATPE.8F0C1D1P0Z56766@fbpe')    # Owner UPI ID for payments
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Zerotomax")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Zerotomax")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Zerotomax")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Zerotomax') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Zerotomax') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Zerotomax') # Update channel link for the bot
